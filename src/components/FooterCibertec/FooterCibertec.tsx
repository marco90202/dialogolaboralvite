    ...
    <ContainerFooter>
      <div>
        <div style={{ marginTop: "30px" }}>
          <img
            style={{ paddingTop: "25px", paddingLeft: "124px" }}
            src={logoCibertec}
            alt="logoCibertec"
          />
        </div>
        <div
          style={{ display: "flex", paddingTop: "80px", paddingLeft: "90px" }}
        >
      ...
      <div style={{ paddingTop: "68px", paddingLeft: "108px" }}>
        <img style={{ paddingRight: "15px" }} src={iconHoja} alt="iconHoja" />
        <img src={textLaureate} alt="textLaureate" />
      </div>
      <div style={{ paddingTop: "72px", paddingLeft: "48px" }}>
        <img style={{ paddingRight: "15px" }} src={iconUpc} alt="iconUpc" />
        <img src={textUpc} alt="textUpc" />
      </div>
      <div style={{ paddingTop: "56px", paddingLeft: "48px" }}>
        <img src={iconBook} alt="iconBook" />
        <TextDirection>
          Instituto superior privado CIBERTEC S.A.C - 2021 J. Uruguar 512 Lima
          Todos los derechos reservados
        </TextDirection>
      </div>
      <div style={{ paddingTop: "172px", paddingLeft: "40px" }}>
